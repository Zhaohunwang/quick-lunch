...
**使用场景：**
- 项目/工作区添加完成后，手动刷新以确认数据已更新
- 外部修改项目文件后，刷新列表以获取最新数据
- IDE配置变更后，刷新以更新可用IDE列表

**数据刷新：**
- 自动刷新：项目添加、工作区添加、项目编辑、工作区编辑等操作完成后自动刷新
- 手动刷新：点击刷新按钮触发全量数据刷新
